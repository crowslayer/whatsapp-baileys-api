...
describe('SendDocumentController', () => {
  ...
  beforeEach(() => {
    ...
    req = {
      ...
      body: { to: '521234567890@s.whatsapp.net', caption: 'Check this doc' },
      file: {
  ...
  test('should dispatch SendDocumentCommand and return 200', async () => {
    ...
    expect(dispatched.constructor.name).toBe('SendDocumentCommand');
