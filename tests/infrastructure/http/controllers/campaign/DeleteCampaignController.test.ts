...
import { DeleteCampaignController } from '../../../../../src/infrastructure/http/controllers/campaign/DeleteCampaignController';

describe('DeleteCampaignController', () => {
  let mockCommandBus: { dispatch: ReturnType<typeof vi.fn> };
  let controller: DeleteCampaignController;
  ...
  beforeEach(() => {
    ...
    controller = new DeleteCampaignController(mockCommandBus);
    req = {
      params: { id: 'camp-1' },
      ip: '127.0.0.1',
  ...
  test('should dispatch DeleteCampaignCommand and return 200', async () => {
    ...
    expect(dispatched.constructor.name).toBe('DeleteCampaignCommand');
