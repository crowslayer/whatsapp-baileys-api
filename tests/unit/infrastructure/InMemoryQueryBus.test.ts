...
describe('InMemoryQueryBus', () => {
  test('should dispatch query to handler', async () => {
    const { InMemoryQueryBus } = await import('../../../src/shared/infrastructure/query-bus/in-memory/InMemoryQueryBus')
    const { QueryHandlers } = await import('../../../src/shared/infrastructure/query-bus/QueryHandlers')
