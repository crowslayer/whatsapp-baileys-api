...
describe('SendStickerController', () => {
  ...
  beforeEach(() => {
    ...
    req = {
      ...
      body: { to: '521234567890@s.whatsapp.net' },
      file: { buffer: Buffer.from('test'), size: 400, mimetype: 'image/webp', originalname: 'sticker.webp' } as any,
      ip: '127.0.0.1',
  ...
  test('should dispatch SendStickerCommand and return 200', async () => {
    ...
    expect(dispatched.constructor.name).toBe('SendStickerCommand');
