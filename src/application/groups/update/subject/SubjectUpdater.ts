...
export class SubjetUpdater {
  constructor(
    private readonly repository: IWhatsAppInstanceRepository,
    private readonly runtimeManager: IRuntimeManager
  ) {}

  async execute(instanceId: InstanceId, groupId: string, subject: string): Promise<void> {
    ...
    return await adapter.groups.updateGroupSubject(groupId, subject);
  }
}
